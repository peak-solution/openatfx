package de.rechner.openatfx_mdf4.channelinfo.attachmentref;
...
/**
 * Test case for reading the example MDF4-file <code>Vector_AttachmentRef.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_Vector_AttachmentRef {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/channelinfo/attachmentref/Vector_AttachmentRef.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_Vector_AttachmentRef.class);
    }
