package de.rechner.openatfx_mdf4.channelinfo.defaultx;
...
/**
 * Test case for reading the example MDF4-file <code>Vector_DefaultX.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_Vector_DefaultX {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/channelinfo/defaultx/Vector_DefaultX.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_Vector_DefaultX.class);
    }
