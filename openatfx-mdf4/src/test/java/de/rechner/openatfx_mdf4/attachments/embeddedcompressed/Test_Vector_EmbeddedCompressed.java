package de.rechner.openatfx_mdf4.attachments.embeddedcompressed;
...
/**
 * Test case for reading the example MDF4-file <code>Vector_EmbeddedCompressed.MF4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_Vector_EmbeddedCompressed {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/attachments/embeddedcompressed/Vector_EmbeddedCompressed.MF4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_Vector_EmbeddedCompressed.class);
    }
