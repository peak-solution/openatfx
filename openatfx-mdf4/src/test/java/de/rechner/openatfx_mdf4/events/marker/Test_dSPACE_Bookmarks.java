package de.rechner.openatfx_mdf4.events.marker;
...
/**
 * Test case for reading the example MDF4-file <code>dSPACE_Bookmarks.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_dSPACE_Bookmarks {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/events/marker/dSPACE_Bookmarks.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_dSPACE_Bookmarks.class);
    }
