package de.rechner.openatfx_mdf4.events.trigger;
...
/**
 * Test case for reading the example MDF4-file <code>dSPACE_HILAPITimeout.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_dSPACE_HILAPITimeout {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/events/trigger/dSPACE_HILAPITimeout.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_dSPACE_HILAPITimeout.class);
    }
