package de.rechner.openatfx_mdf4.events.recording;
...
/**
 * Test case for reading the example MDF4-file <code>dSPACE_CaptureBlocks.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_dSPACE_CaptureBlocks {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/events/recording/dSPACE_CaptureBlocks.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_dSPACE_CaptureBlocks.class);
    }
