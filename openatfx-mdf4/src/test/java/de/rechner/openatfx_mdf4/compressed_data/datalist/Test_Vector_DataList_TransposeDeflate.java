package de.rechner.openatfx_mdf4.compressed_data.datalist;
...
/**
 * Test case for reading the example MDF4-file <code>Vector_DataList_TransposeDeflate.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_Vector_DataList_TransposeDeflate {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/compressed_data/datalist/Vector_DataList_TransposeDeflate.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_Vector_DataList_TransposeDeflate.class);
    }
