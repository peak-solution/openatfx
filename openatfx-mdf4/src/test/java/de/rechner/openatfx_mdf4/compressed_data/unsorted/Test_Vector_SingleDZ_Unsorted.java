package de.rechner.openatfx_mdf4.compressed_data.unsorted;
...
/**
 * Test case for reading the example MDF4-file <code>Vector_SingleDZ_Unsorted.MF4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_Vector_SingleDZ_Unsorted {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/compressed_data/unsorted/Vector_SingleDZ_Unsorted.MF4";
    ...
    public void testReadIDBlock() {
        try {
            ...
            assertEquals("MCD_9.0", ODSHelper.getStringVal(ieTst.getValue("mdf_program")));
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_Vector_SingleDZ_Unsorted.class);
    }
