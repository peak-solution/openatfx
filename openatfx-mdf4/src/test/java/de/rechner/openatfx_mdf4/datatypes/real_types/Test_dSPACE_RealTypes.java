...
/**
 * Test case for reading the example MDF4-file <code>dSPACE_RealTypes.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_dSPACE_RealTypes {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/datatypes/real_types/dSPACE_RealTypes.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_dSPACE_RealTypes.class);
    }
