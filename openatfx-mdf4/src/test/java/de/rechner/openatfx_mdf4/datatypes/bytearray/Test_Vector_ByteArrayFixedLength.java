package de.rechner.openatfx_mdf4.datatypes.bytearray;
...
/**
 * Test case for reading the example MDF4-file <code>Vector_ByteArrayFixedLength.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_Vector_ByteArrayFixedLength {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/datatypes/bytearray/Vector_ByteArrayFixedLength.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_Vector_ByteArrayFixedLength.class);
    }
