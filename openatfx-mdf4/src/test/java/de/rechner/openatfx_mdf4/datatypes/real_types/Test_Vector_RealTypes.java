package de.rechner.openatfx_mdf4.datatypes.real_types;
...
/**
 * Test case for reading the example MDF4-file <code>Vector_RealTypes.MF4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_Vector_RealTypes {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/datatypes/real_types/Vector_RealTypes.MF4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_Vector_RealTypes.class);
    }
