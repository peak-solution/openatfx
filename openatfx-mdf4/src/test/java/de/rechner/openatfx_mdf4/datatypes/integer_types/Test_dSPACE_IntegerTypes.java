...
/**
 * Test case for reading the example MDF4-file <code>dSPACE_IntegerTypes.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_dSPACE_IntegerTypes {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/datatypes/integer_types/dSPACE_IntegerTypes.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_dSPACE_IntegerTypes.class);
    }
