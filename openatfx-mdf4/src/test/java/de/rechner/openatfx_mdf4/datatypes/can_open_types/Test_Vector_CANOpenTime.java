...
/**
 * Test case for reading the example MDF4-file <code>Vector_CANOpenTime.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_Vector_CANOpenTime {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/datatypes/can_open_types/Vector_CANOpenTime.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_Vector_CANOpenTime.class);
    }
