...
/**
 * Test case for reading the example MDF4-file <code>Vector_FixedLengthStringSBC.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_Vector_FixedLengthStringSBC {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/datatypes/string_types/Vector_FixedLengthStringSBC.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_Vector_FixedLengthStringSBC.class);
    }
