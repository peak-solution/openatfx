...
public class Test_Vector_ArrayWithFixedAxes {
    ...
    private static final String mdfFile = "de/rechner/openatfx_mdf4/arrays/simple/Vector_ArrayWithFixedAxes.MF4";
    ...
    public void testReadFHBlock() {
        try {
            ...
            assertEquals(1337863192000000334l, ODSHelper.getLongLongVal(ieFh.getValue("start_time_ns")));
