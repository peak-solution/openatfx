package de.rechner.openatfx_mdf4.conversion.text_conversion;
...
/**
 * Test case for reading the example MDF4-file <code>Vector_AlgebraicConversionQuadratic.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_Vector_AlgebraicConversionQuadratic {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/conversion/text_conversion/Vector_AlgebraicConversionQuadratic.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_Vector_AlgebraicConversionQuadratic.class);
    }
