...
/**
 * Test case for reading the example MDF4-file <code>Vector_Value2TextConversion.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_Vector_Value2TextConversion {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/conversion/lookup_conversion/Vector_Value2TextConversion.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_Vector_Value2TextConversion.class);
    }
