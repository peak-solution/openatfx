package de.rechner.openatfx_mdf4.conversion.rational_conversion;
...
/**
 * Test case for reading the example MDF4-file <code>Vector_RationalConversionZeroedParams.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_Vector_RationalConversionZeroedParams {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/conversion/rational_conversion/Vector_RationalConversionZeroedParams.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_Vector_RationalConversionZeroedParams.class);
    }
