...
/**
 * Test case for reading the example MDF4-file <code>dSPACE_AlgebraicConversion.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_dSPACE_AlgebraicConversion {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/conversion/text_conversion/dSPACE_AlgebraicConversion.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_dSPACE_AlgebraicConversion.class);
    }
