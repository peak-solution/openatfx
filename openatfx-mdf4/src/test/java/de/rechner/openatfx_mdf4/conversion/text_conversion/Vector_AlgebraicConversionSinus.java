...
/**
 * Test case for reading the example MDF4-file <code>Vector_AlgebraicConversionSinus.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Vector_AlgebraicConversionSinus {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/conversion/text_conversion/Vector_AlgebraicConversionSinus.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Vector_AlgebraicConversionSinus.class);
    }
