...
/**
 * Test case for reading the example MDF4-file <code>dSPACE_Value2ValueConversionInterpolation.mf4</code>.
 * 
 * @author Christian Rechner
 */
public class Test_dSPACE_Value2ValueConversionInterpolation {

    private static final String mdfFile = "de/rechner/openatfx_mdf4/conversion/lookup_conversion/dSPACE_Value2ValueConversionInterpolation.mf4";
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(Test_dSPACE_Value2ValueConversionInterpolation.class);
    }
