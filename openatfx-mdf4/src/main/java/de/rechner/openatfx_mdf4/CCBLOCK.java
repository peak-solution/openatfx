...
class CCBLOCK extends BLOCK {
    ...
    public static CCBLOCK read(SeekableByteChannel channel, long pos) throws IOException {
        ...
        block.setType(MDFUtil.readUInt8(bb));
