...
public class ODSHelperBitShiftTest {
    ...
    public void testGetBitIntValue40Bit0Offset() {
        byte[][] bytes = new byte[][] { 
            new byte[] {(byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00}, // 0
            ...
            new byte[] {(byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x80}, // -549_755_813_888 (min) 
            new byte[] {(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0x7F}  // 549_755_813_887 (max)
        };

        long[] expected = 
                new long[] { 0L, 1L, -1L, 491178394240L, -256198828310L, -549755813888L, 549755813887L };
    ...
    public void testGetBitIntValue24Bit0Offset() {
        byte[][] bytes = new byte[][] { 
            new byte[] {(byte) 0x00, (byte) 0x00, (byte) 0x00}, // 0
    ...
    public void testGetBitIntValueSigned64Bit2OffsetBE() {
        byte [] bytes = new byte[] { (byte) 0x03, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF,
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(ODSHelperBitShiftTest.class);
    }
