...
import de.rechner.openatfx.basestructure.BasicModelReader;
...
class ApplicationAttributeImpl extends ApplicationAttributePOA {
    ...
    public void setBaseAttribute(BaseAttribute baseAttr) throws AoException {
        if (baseAttr != null) {
            ...
            this.autogenerated = BasicModelReader.isAutogenerated(baseAttr.getBaseElement().getType(), baseAttr.getName());
