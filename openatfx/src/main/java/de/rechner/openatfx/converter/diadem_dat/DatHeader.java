...
class DatHeader {
    ...
    public static final int KEY_FILE_OFFSET = 221; // Pointer to the 1st value in the channel
    public static final int KEY_CHANNEL_OFFSET = 222; // Offset for binary block files with header
