...
public class AtfxTagConstants {
    ...
    public static final String BA_MIME_TYPE = "mime_type";
    
    public static final String SUB_MATRIX = "submatrix";
    public static final String MAT_ATTR_NROFROWS = "number_of_rows";
    
    public static final String LC = "aolocalcolumn";
    public static final String LC_VALUES = "values";
    public static final String LC_FLAGS = "flags";
    public static final String LC_GEN_PARAMS = "generation_parameters";
    public static final String LC_SEQ_REP = "sequence_representation";
    public static final String LC_GLOBAL_FLAG = "global_flag";
