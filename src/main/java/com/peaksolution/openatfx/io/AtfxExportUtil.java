 ...
 */
public abstract class AtfxExportUtil {
     ...
     * @return The string.
     */
    public static String createLongLongString(long l) {
     ...
     * @return The string.
     */
    public static String createLongLongSeqString(long[] ll) {
        StringBuilder sb = new StringBuilder();
     ...
     * 
     * @param dAr The sequence of double values.
     * @return The string.
     */
     ...
     * @return The string.
     */
    public static String createComplexString(Complex c) {
        StringBuilder sb = new StringBuilder();
        sb.append(c.getR());
        sb.append(" ");
        sb.append(c.getI());
     ...
     * @return The string.
     */
    public static String createComplexSeqString(Complex[] cAr) {
        StringBuilder sb = new StringBuilder();
     ...
     * @return The string.
     */
    public static String createDComplexString(DoubleComplex c) {
        StringBuilder sb = new StringBuilder();
        sb.append(c.getR());
        sb.append(" ");
        sb.append(c.getI());
     ...
     * @return The string.
     */
    public static String createDComplexSeqString(DoubleComplex[] cAr) {
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < cAr.length; i++) {
