...
class ColumnImpl extends ColumnPOA {
    ...
    private final CorbaAtfxCache atfxCache;
     ...
     */
    public ColumnImpl(POA modelPOA, CorbaAtfxCache atfxCache, InstanceElement ieLocalColumn, ValueMatrixMode mode) {
    ...
    public InstanceElement getSourceMQ() throws AoException {
        ...
        Collection<Long> aids = this.atfxCache.getAidsByBaseType("aolocalcolumn");
