...
/**
 * Test case for getBitShiftedValue() method from <code>com.peaksolution.openatfx.util.ODSHelper</code>.
 * 
 * @author Martin Fleischer
 */
class ODSHelperBitShiftTest {

    @Test
    void testGetBitIntValue40Bit0Offset() {
    ...
    @Test
    void testGetBitIntValue24Bit0Offset() {
    ...
    @Test
    void testGetBitIntValueUnsigned32Bit0OffsetBE() {
    ...
    @Test
    void testGetBitIntValueSigned64Bit2OffsetBE() {
     ...
     */
    @Test
    void testGetBitIntValueUnsigned14Bit6OffsetLE() {
     ...
     */
    @Test
    void testGetBitIntValueUnsigned14Bit6OffsetBE() {
        byte[] bytes = new byte[] { (byte) 0xAB, (byte) 0xCD, (byte) 0xEF };
     ...
     */
    @Test
    void testGetBitIntValueSigned14Bit6OffsetLE() {
        byte[] bytes = new byte[] { (byte) 0xAB, (byte) 0xCD, (byte) 0xEF };
     ...
     */
    @Test
    void testGetBitIntValueSigned14Bit6OffsetBE() {
        byte[] bytes = new byte[] { (byte) 0xAB, (byte) 0xCD, (byte) 0xEF };
