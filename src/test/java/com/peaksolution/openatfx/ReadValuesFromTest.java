...
public class ReadValuesFromTest {
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        URL url = InstanceElementImplTest.class.getResource("/com/peaksolution/openatfx/test.atfx");
    ...
    @Test
    void testGetValueVectorImplicitLinear() {
        try {
    ...
    @Test
    void testGetValueVectorImplicitConstant() {
        try {
